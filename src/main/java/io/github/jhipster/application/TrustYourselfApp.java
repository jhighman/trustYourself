...
public class TrustYourselfApp {

    private static final Logger log = LoggerFactory.getLogger(TrustYourselfApp.class);

    private final Environment env;

    public TrustYourselfApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes trustYourself.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TrustYourselfApp.class);
